...
python -u train_debug.py \
    ...
    model.name=accounts/fireworks/models/deepseek-v4-flash \
    model.tokenizer_model=deepseek-ai/DeepSeek-V4-Flash \
    model.lora_rank=128 \
    fireworks_config.policy_trainer_shape_id=accounts/fireworks/trainingShapes/deepseek-v4-flash-256k-lora \
    ...
    rllm.trainer.experiment_name='dsv4-flash-256k-lora-tb-v2-v3-filtered-0822' \
